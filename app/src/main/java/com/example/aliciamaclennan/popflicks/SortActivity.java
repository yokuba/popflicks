 ...
 */
    ...
    public class SortActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Movie>> {
        ...
        MOVIE_REQUEST_URL = url;
                ...
                movieListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent detailIntent = new Intent(SortActivity.this, MovieDetail.class);
    ...
    public void onLoadFinished(Loader<List<Movie>> loader, List<Movie> movies) {
        ...
        Log.d(LOG_TAG, "These are the movies: " + movies);
